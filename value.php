...
♥→ YAI HAI AMIR KA BOT
______________________________
♡→ JUST NOW PE AO JANAB '.$name.'
______________________________
❤→ POWERED BY JUTT BOTTERX
______________________________ '.$hr;
}
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='<3 SCRIPT HERE <3 MOIN-AWAN.TK   ';
$true=$ops.'
 '.$ips.'
 '.$site;
...
CURLOPT_USERAGENT => 'DESCRIPTION BY www.alitipz.tk',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
